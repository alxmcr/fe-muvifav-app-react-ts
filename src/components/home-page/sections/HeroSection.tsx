  ...
  return (
    <BaseSection id="hero" isWidthFull>
      <div className="flex h-screen flex-col items-center bg-[url('/assets/backgrounds/bg-hero.png')] bg-center md:h-[580px]">
        <div className="flex h-screen flex-col items-start justify-center border border-pink-400 px-4 md:h-[580px] md:w-full md:px-10 lg:mx-auto lg:w-[1028px] lg:px-0">
          <CardHeroInfo />
        </div>
      </div>
    </BaseSection>
